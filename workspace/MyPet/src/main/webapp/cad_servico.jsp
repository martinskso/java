...
<body>
	<form action="SalvarCidade" method="post">
		...
		<div class="form-group">
			<label for="nome">Codigo Serviços</label> <input class="form-control"
				name="nome" id="nome" type="text" value="<%=nome%>">
		</div>
		
		<div class="form-group">
			<label for="uf">Descrição</label> <input class="form-control" name="uf"
				id="uf" type="text" value="<%=uf%>">
		</div>
		
		<div class="form-group">
			<label for="uf">Preço</label> <input class="form-control" name="uf"
				id="uf" type="text" value="<%=uf%>">
		</div>
