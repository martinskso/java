...
<body>
	<form action="SalvarCidade" method="post">
		...
		<div class="form-group">
			...
			<label for="codigo">Codigo Pet</label> 
			<input class="form-control" name="codigo" id="codigo" type="text" value="<%=codigo%>">
		</div>
		
			<div class="form-group">
			<label for="nome">Horário Atendimento</label> <input class="form-control"
				name="nome" id="nome" type="text" value="<%=nome%>">
		</div>
		
		<div class="form-group">
			<label for="uf">Clinica</label> <input class="form-control" name="uf"
				id="uf" type="text" value="<%=uf%>">
		</div>
		
		<div class="form-group">
			<label for="uf">Local</label> <input class="form-control" name="uf"
				id="uf" type="text" value="<%=uf%>">
		</div>
